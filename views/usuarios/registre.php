...
<head>
    ...
    <style>
        ...
        .register-left { background: linear-gradient(135deg, #1a3a6b 0%, #2563eb 100%); min-height: 100%; }
        .form-control:focus, .form-select:focus { border-color: #2563eb; box-shadow: none; }
        .btn-registrar { background: #2563eb; border: none; font-weight: 600; font-size: 0.875rem; }
...
<div class="card shadow-lg border-0 rounded-4 overflow-hidden" style="max-width:680px; width:100%;">
    <div class="row g-0">

        <!-- Panel izquierdo -->
        <div class="col-md-4 register-left d-none d-md-flex flex-column justify-content-between p-4 text-white">
            <div>
                <i class="fas fa-car-side fa-2x mb-3 opacity-90"></i>
        ...
        <div class="col-md-8 bg-white p-4">
            <h5 class="fw-bold mb-1">Registro de Cliente</h5>
            <p class="text-muted mb-3" style="font-size:0.8rem;">Completa todos los campos para crear tu cuenta</p>
            ...
            <form action="../../controllers/AuthController.php?accion=registro" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="nombre" class="form-control" placeholder="Juan Carlos Pérez" required>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="correo" class="form-control no-left-border" placeholder="correo@ejemplo.com" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
