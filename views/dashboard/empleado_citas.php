...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-0"><i class="fas fa-calendar-check text-primary me-2"></i>Citas del Taller</h4>
...
<div class="tab-content">
    ...
    <div class="tab-pane fade show active" id="tabPendientes">
        <div class="card shadow-sm rounded-top-0">
            <div class="card-body p-0">
                <?= renderTablaCitasEmpleado($pendientes) ?>
            </div>
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="tabConfirmadas">
        <div class="card shadow-sm rounded-top-0">
            <div class="card-body p-0">
                <?= renderTablaCitasEmpleado($confirmadas) ?>
            </div>
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="tabTodas">
        <div class="card shadow-sm rounded-top-0">
            <div class="card-body p-0">
                <?= renderTablaCitasEmpleado($todasCitas) ?>
            </div>
        </div>
    </div>
...
<?php
function renderTablaCitasEmpleado(array $citas): string {
    $eBadge = [
